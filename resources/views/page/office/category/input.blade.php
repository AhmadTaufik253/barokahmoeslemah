    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend" data-kt-place-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center me-3">
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">
                ...
                <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                <small class="text-muted fs-7 fw-bold my-1 ms-1">{{$category->titles}}</small>
                @else
                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                            <input type="text" id="titles" name="titles" class="form-control form-control-solid" placeholder="Title" value="{{$category->titles}}" />
                                        </div>
                                        <!--end::Input group-->
                                        <!--begin::Input group-->
                                        <div class="mb-5">
                                ...
                                <div class="mb-0">
                                    @if ($category->id)
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('office.category.update',$category->id)}}','PATCH','Save');" class="btn btn-light-primary">Save</button>
                                    @else
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('office.category.store')}}','POST','Save');" class="btn btn-light-primary">Save</button>
                                    @endif
                                </div>
                                <!--end::Button-->
                            </div>
