                            ...
                            <div class="mb-0">
                                ...
                                <div class="row gx-12 mb-5">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-5">
                                            <input type="text" id="name" name="name" class="form-control form-control-solid" placeholder="Name" value="{{$user->name}}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Phone Number</label>
                                        <div class="mb-5">
                                            <input type="tel" id="phone" name="phone" class="form-control form-control-solid" placeholder="Phone Number" value="{{$user->phone}}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="form-label fs-6 fw-bolder text-gray-700 mb-3">Email</label>
                                        <div class="mb-5">
                                            <input type="email" id="email" name="email" class="form-control form-control-solid" placeholder="Email" value="{{$user->email}}" />
                                        </div>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <!--begin::Button-->
                                <div class="mb-0">
                                    <button id="tombol_simpan" onclick="handle_upload('#tombol_simpan','#form_input','{{route('office.customer.update',$user->id)}}','PATCH','Save');" class="btn btn-light-primary">Save</button>
                                </div>
                                <!--end::Button-->
                            </div>
                            <!--end::Wrapper-->
