<x-office-layout title="Customer">
    <div id="content_list">
        <!--begin::Toolbar-->
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center py-1">
                    ...
                    <div class="me-4">
                        <!--begin::Menu-->
                        <a href="{{route('office.generate.pdf')}}" target="_blank" class="btn btn-sm btn-flex btn-primary btn-active-secondary fw-bolder">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true">
                            ...
                            <form id="content_filter">
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label fw-bold">Name / Email / Phone:</label>
                                        <!--end::Label-->
