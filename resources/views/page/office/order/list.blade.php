        ...
        @if ($collection->count()>0)
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="d-flex justify-content-start flex-column">
                            ...
                            <span class="text-muted fw-bold text-muted d-block fs-7">{{$item->subdistrict->subdistrict_name}}, {{$item->city->city_name}}</span>
                            <span class="text-muted fw-bold text-muted d-block fs-7">{{$item->province->province_name}}, {{$item->postcode}}</span>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="d-flex align-items-center">
                        <div class="d-flex justify-content-start flex-column">
                            <a href="javascript:;" class="text-dark fw-bolder text-hover-primary fs-6">{{$item->ekspedisi}}</a>
                            <span class="text-muted fw-bold text-muted d-block fs-7">{{$item->type}} | Rp {{number_format($item->ongkir)}}</span>
                        </div>
                    </div>
                </td>
                <td>
                ...
                <td>
                    <div class="d-flex align-items-center">
                        <div class="d-flex justify-content-start flex-column">
                            <a href="javascript:;" class="text-dark fw-bolder text-hover-primary fs-6">{{$item->st}}</a>
                        </div>
                    </div>
                </td>
                <td class="text-end">
                ...
                <td class="text-end">
                    ...
                    @elseif($item->st == "Order on process")
