            ...
            <form class="form w-100" novalidate="novalidate" id="form_login">
                ...
                <div class="fv-row mb-10">
                    ...
                    <div class="d-flex flex-stack mb-2">
                        ...
                        <a href="javascript:;" onclick="auth_content('forgot_page');" class="link-primary fs-6 fw-bolder">Lupa password ?</a>
                        <!--end::Label-->
                    </div>
                    <!--end::Wrapper-->
                    <!--begin::Input-->
        ...
        <div class="w-lg-500px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <form class="form w-100" novalidate="novalidate" id="forgot_form">
                ...
                <div class="fv-row mb-10">
                    ...
                    <input class="form-control form-control-solid" type="email" placeholder="" id="email_forgot" name="email" autocomplete="off" />
                </div>
                <!--end::Input group-->
                <!--begin::Actions-->
                <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                    <button type="button" id="tombol_lupa" class="btn btn-lg btn-primary fw-bolder me-4">
                        <span class="indicator-label">Submit</span>
                        <span class="indicator-progress">Please wait...
                            <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                    </button>
                    <a href="javascript:;" onclick="auth_content('login_page');" class="btn btn-lg btn-light-primary fw-bolder">Cancel</a>
                </div>
                <!--end::Actions-->
            </form>
            <!--end::Form-->
