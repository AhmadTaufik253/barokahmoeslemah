                ...
                <form id="form_checkout">
                    <div class="row col-mb-50 gutter-50">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-12 form-group">
                                            ...
                                            <input type="text" id="address" name="address" value="{{Auth::user()->address}}" class="sm-form-control" />
                                        </div>
                        ...
                        <div class="col-lg-12" id="payment_content">
                            ...
                            <button id="tombol_checkout" onclick="handle_upload('#tombol_checkout','#form_checkout','{{route('user.checkout.store')}}','POST','Place Order')" class="button button-3d float-end">Place Order</button>
                        </div>
                    </div>
                </form>
            </div>
