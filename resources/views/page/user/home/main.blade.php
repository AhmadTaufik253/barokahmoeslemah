                ...
                <div class="row gutter-40 col-mb-80">
                    ...
                    <div class="postcontent col-lg-12 order-lg-last">
                        ...
                        <div id="shop" class="shop row grid-container gutter-20" data-layout="fitRows">
                            ...
                            $product = \App\Models\Product::orderBy("id","desc")->limit(6)->get();
                            @endphp
                                    ...
                                    <div class="product-image">
                                        ...
                                        <div class="bg-overlay">
                                            <div class="bg-overlay-content align-items-end justify-content-between" data-hover-animate="fadeIn" data-hover-speed="400">
                                                <a href="{{route('user.product.show',$item->slug)}}" class="btn btn-dark me-2"><i class="icon-shopping-cart"></i></a>
                                    ...
                                    <div class="product-desc">
                                        <center>
                                            <div class="product-title">
                                                <h3><a href="{{route('user.product.show',$item->slug)}}">{{$item->titles}}</a></h3>
                                            </div>
                                        </center>
                                        <center>
