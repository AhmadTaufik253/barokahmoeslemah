<div id="kt_aside" class="aside aside-dark" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    ...
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="?page=index">
            <img alt="Logo" src="{{asset('img/logo_admin.jpg')}}" class="w-200px logo" />
        </a>
        <!--end::Logo-->
        <!--begin::Aside toggler-->
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                <div class="menu-item">
                    <a class="menu-link {{request()->is('office/dashboard') ? 'active' : ''}}" href="{{route('office.dashboard')}}">
                ...
                <div class="menu-item">
                    <a class="menu-link {{request()->is('office/banner') ? 'active' : ''}}" href="{{route('office.banner.index')}}">
                        <span class="menu-icon">
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('office/category') || request()->is('office/product') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion {{request()->is('office/category') || request()->is('office/product') ? 'menu-active-bg' : ''}}">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/category') ? 'active' : ''}}" href="{{route('office.category.index')}}">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/product') ? 'active' : ''}}" href="{{route('office.product.index')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('office/customer') || request()->is('office/employee') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion {{request()->is('office/customer') || request()->is('office/employee') ? 'menu-active-bg' : ''}}">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/customer') ? 'active' : ''}}" href="{{route('office.customer.index')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('office/employee') ? 'active' : ''}}" href="{{route('office.employee.index')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
